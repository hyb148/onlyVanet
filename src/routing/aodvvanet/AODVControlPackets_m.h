...
/**
 * Enum generated from <tt>src/routing/aodvvanet/AODVControlPackets.msg</tt> by opp_msgc.
 * <pre>
...
/**
 * Struct generated from src/routing/aodvvanet/AODVControlPackets.msg by opp_msgc.
 */
...
/**
 * Class generated from <tt>src/routing/aodvvanet/AODVControlPackets.msg</tt> by opp_msgc.
 * <pre>
...
class AODVRREQ : public ::AODVControlPacket
{
  ...
  public:
    ...
    virtual Coord getSpeed() const;
    virtual void setSpeed(Coord position);
    virtual Coord getDirection() const;
    virtual void setDirection(Coord position);
    virtual double getLinkReliability() const;
    virtual void setLinkReliability(double linkReliability);
};
...
class AODVRREP : public ::AODVControlPacket
{
  ...
  public:
    ...
    virtual void setRouteReliability(double route_reliability);
};
